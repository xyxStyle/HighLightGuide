package com.xyx.highlightguide.shape;
...
public abstract class BaseLightShape implements HighLight.LightShape {
     ...
     * @param bitmap
     * @param viewPosInfo
     * @see com.xyx.highlightguide.view.HightLightView#addViewForEveryTip(HighLight.ViewPosInfo)
     * @see com.xyx.highlightguide.view.HightLightView#buildMask()
     */
